    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md">
                        <a class="btn col-12 text-nowrap btn-primary" href="{{ route('invoices.create')}}" role="button">Nueva Factura  
                    ...
                    <div class="col-md">
                        <a id="showInvoice" class="btn col-12 text-nowrap btn-disabled" href="#" role="button">Ver 
                    ...
                    <div class="col-md">
                        <a id="editInvoice" class="btn col-12 text-nowrap btn-disabled" href="#" role="button">Editar
                            <svg class="bi" width="24" height="24" fill="currentColor">
                    ...
                    <div id ="deleteInvoice" class="col-md">
                        <a class="btn col-12 text-nowrap btn-disabled" href="#" role="button">Borrar
                            <svg class="bi" width="24" height="24" fill="currentColor">
